  ...
  return (
    <Box display="flex" flexDirection="column">
      ...
      <SettingsSwitch
        ...
        setToggle={(val) =>
          props.setVizOptions({ ...props.vizOptions, showColdRadiators: val })
        }
      ...
      <SettingsSwitch
        ...
        setToggle={(val) =>
          props.setVizOptions({ ...props.vizOptions, showLongRadiators: val })
        }
      ...
      <SettingsSwitch
        ...
        setToggle={(val) =>
          props.setVizOptions({ ...props.vizOptions, showEmptyUnits: val })
        }
        name="Show All Units"
      />
      <SettingsSwitch
        ...
        setToggle={(val) =>
          props.setVizOptions({ ...props.vizOptions, showEmptySpaces: val })
        }
